 ...
 *
  ...
  'join': {
    ...
    'WebkitBoxShadow': '0 0 200px rgba(255, 255, 255, 0.5), 0 1px 2px
		 rgba(0, 0, 0, 0.3)',
    'boxShadow': [{ 'unit': 'px', 'value': 0 }, { 'unit': 'px', 'value': 0 }, { 'unit': 'px', 'value': 200 }, { 'unit': 'string', 'value': 'rgba(255, 255, 255, 0.5)' }, { 'unit': 'string', 'value': 'rgba(255, 255, 255, 0.5),' }, { 'unit': 'px', 'value': 0 }, { 'unit': 'px', 'value': 1 }, { 'unit': 'px', 'value': 2 }, { 'unit': 'string', 'value': 'rgba(0, 0, 0, 0.3)' }],
    // Transition
